...
<body>
   ...
   <div class="container">
        ...
        <form action = "WDS" method = "post">
            <div class = "form-group">
               <input type="text" name="textWorkOutType"  placeholder="Enter your Work Out Type">
            </div>
            <div class = "form-group">
                <input type="text" name="textDuration"  placeholder="Enter your Duration of Work Out">
            </div>
             <div class = "form-group">
                <input type="text" name="textCalories"  placeholder="Enter your Calories Burnt ">
             </div>
