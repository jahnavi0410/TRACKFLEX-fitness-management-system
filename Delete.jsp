...
<body>
    ...
    <div class="container">
        <h4>DO YOU WANT TO PERMANANTLY DELETE ACCOUNT?</h4>
          <form action = "DeleteACC"  method = "post"><button class="btn">YES</button>  </form>
         <a href = "AboutUS.jsp"><button class="btn">NO</button></a>
