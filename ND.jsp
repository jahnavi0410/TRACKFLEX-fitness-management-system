...
<body>
    ...
    <div class="container">
         ...
         <div class = "form-group">
               <input type="text" name="textFoodType"  placeholder="Enter Type of Food Consumed">
            </div>
            <div class = "form-group">
                <input type="text" name="textCalConsumed"  placeholder="Enter the Calories Consumption">
            </div>
             <div class = "form-group">
                <input type="text" name="textWaterConsumed"  placeholder="Enter the Water Consumption in Litres ">
             </div>
